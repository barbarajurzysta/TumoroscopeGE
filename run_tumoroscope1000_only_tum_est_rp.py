...
# r=np.array(data['Gamma']['phi_gamma'])[0], p=np.array(data['Gamma']['phi_gamma'])[1]
        r, p = None, None
        tum_1 = tum1.tumoroscope(name=result_obj, K=K, S=S, r=r, p=p, I=len(C_ik),
                                 ...
                                 result_txt=result_txt, rp_est_method='tum')
        ...
        np.save('H_tum/' + result_dir + '_h.npy', tum_1.inferred_H)
    else:
